...
public class Config {
    public static List<String> provinces = Arrays.asList(
            ...
            "Trà Vinh", "Tuyên Quang", "Vĩnh Long", "Vĩnh Phúc", "Yên Bái", "Thành phố Hồ Chí Minh"
    );
    ...
    public static String vnp_TmnCode = "HQGE4SGI";
    public static String vnp_HashSecret="QIJEZADPUYCQKWNVVHIHOFFUKIQDIKHH";
